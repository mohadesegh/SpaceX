...
function PastLaunchesData() {
  ...
  //fetch data from api
  useEffect(() => {
    axios.get("https://api.spacexdata.com/v3/launches/past").then((data) => {
      console.log(data);
      setPastLaunches(data?.data);
    });
...
export default PastLaunchesData;
